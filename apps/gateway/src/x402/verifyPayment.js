...
function getClient(config = defaultConfig) {
    if (!cachedClient) {
 ...
 */
export async function verifyX402Payment(proof, expectedAmount, receiverAddress, config = defaultConfig) {
 ...
 */
export async function verifyPaymentSimple(proof, expectedAmount, receiverAddress) {
