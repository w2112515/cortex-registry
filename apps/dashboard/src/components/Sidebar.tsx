...
import { Star, PlusCircle, LayoutGrid } from 'lucide-react';
    ...
    return (
        <>
            ...
            <div className={`
                ...
                bg-[#050505]/95 md:bg-[#050505]/90 
                border-r border-grid-line z-50 flex flex-col backdrop-blur-xl
                transition-transform duration-300 ease-in-out
                ${mobileOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}
            `}>
                {/* Brand Header */}
                <div className="p-6 border-b border-grid-line flex justify-between items-center">
                    <div>
                    ...
                    <nav className="flex flex-col gap-1">
                        <Link href="/" className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-white/5 transition-colors group">
                            <div className="w-4 h-4 rounded-full border border-neon-cyan/50 group-hover:border-neon-cyan group-hover:shadow-[0_0_8px_rgba(0,212,255,0.5)] transition-all flex items-center justify-center">
                                <Star size={10} className="text-neon-cyan" />
                            </div>
                            <span className="font-mono text-xs text-gray-300 group-hover:text-white tracking-wider uppercase">Star Map</span>
                        </Link>
                        <Link href="/register" className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-white/5 transition-colors group">
                            <div className="w-4 h-4 rounded border border-gray-600 group-hover:border-neon-purple group-hover:shadow-[0_0_8px_rgba(176,38,255,0.5)] transition-all flex items-center justify-center">
                                <PlusCircle size={10} className="text-gray-500 group-hover:text-neon-purple" />
                            </div>
                            <span className="font-mono text-xs text-gray-300 group-hover:text-white tracking-wider uppercase">Register</span>
                        </Link>
                        <Link href="/workflow" className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-white/5 transition-colors group">
                            <div className="w-4 h-4 rounded border border-gray-600 group-hover:border-neon-purple group-hover:shadow-[0_0_8px_rgba(176,38,255,0.5)] transition-all flex items-center justify-center">
                                <LayoutGrid size={10} className="text-gray-500 group-hover:text-neon-purple" />
                            </div>
                            <span className="font-mono text-xs text-gray-300 group-hover:text-white tracking-wider uppercase">Workflow</span>
                        </Link>
                    </nav>
                </div>
